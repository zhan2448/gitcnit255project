...
namespace FinalVersion
{
    public partial class ViewInputTableControll : UIViewController
    {
        ...
        private List<Expression> returnExpression= new List<Expression>();
        ...
        public override void ViewDidLoad()
        {
            ...
            else if (tempExpression.Count == 2)
            {
                ...
                InPutTable2.Hidden = false;
                preparetable((List<Expression>)tempExpression[1], InPutTable2,2);
        ...
        public void preparetable(List<Expression> Input, UITableView tb,int i)
        {
            var FormulaInPutTable = new FormulaInPutTable(Input);
            FormulaInPutTable.SelectExpression += (sender, e) =>
            {
               returnExpression.Add(FormulaInPutTable.temp);
                LabelAndButton(returnExpression,i);
            };
            tb.Source = FormulaInPutTable;
        }
